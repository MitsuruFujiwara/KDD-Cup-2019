...
#python 005_queries_plans.py
#python 101_train_lgbm_queries.py
#python 102_train_lgbm_queries_profiles.py
#python 103_train_lgbm_queries_plans.py
#python 006_aggregation.py
#python 801_optimize_lgbm_queries_optuna.py
#python 802_optimize_lgbm_queries_profiles_optuna.py
#python 803_optimize_lgbm_queries_plans_optuna.py
python 103_train_lgbm.py
python 104_train_xgb.py
python 201_blend.py
